...
fun PullToRefreshIndicator(
    ...
    refreshingOffset: Dp,
    modifier: Modifier = Modifier,
    textStyle: TextStyle = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onPrimary, fontSize = 14.sp),
) {
