 ...
 */
internal class NearestRangeKeyIndexMapState @OptIn(ExperimentalFoundationApi::class) constructor(
 ...
 */
@OptIn(ExperimentalFoundationApi::class)
internal class NearestRangeKeyIndexMap @OptIn(ExperimentalFoundationApi::class) constructor(
