...
void matrixIdentityFunction(float* matrix) {
    ...
    //this is the special identify matrix, which is similar to the real number 1.
    // any matrix times the identity matrix will return the same matrix
...
/**
 * left, right: Horizontal boundaries of the frustum at the near plane.
 * bottom, top: Vertical boundaries of the frustum at the near plane.
 * zNear, zFar: Distances to the near and far clipping planes.
 * */
